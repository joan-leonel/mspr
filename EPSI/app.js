...
const ConnectedDevice = require("./model/connectDevice");
const connectDevice = require("./model/connectDevice");
...
app.post("/qr/generate", async (req, res) => {
  ...
  app.post("/qr/scan", async (req, res) => {
    try {
      ...
      const connectedDevice = await connectDevice.create(connectedDeviceData);
